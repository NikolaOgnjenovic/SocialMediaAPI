...
public class UserProfile : Profile
{
    public UserProfile()
    {
        ...
        .ForMember(user => user.Followers,  opt => opt.MapFrom(src => new List<User>()))
        .ForMember(user => user.Following,  opt => opt.MapFrom(src => new List<User>()))
        .ForMember(user => user.PostLikes,  opt => opt.MapFrom(src => new List<PostLike>()))
        .ForMember(user => user.CommentLikes,  opt => opt.MapFrom(src => new List<CommentLike>()));
